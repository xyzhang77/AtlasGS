...
def load_poses(scene_path):
    images = read_extrinsics_text(os.path.join(scene_path, "sparse", "images.txt"))
    poses = []
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', type=str, default="/mnt/nas_10/group/zhangxiyu/datasets/scannet/scans")
    parser.add_argument('--gt_mesh', type=str, default=None)
    parser.add_argument('--result_folder', type=str, default=None)
    args = parser.parse_args()

    # root_dir = "/mnt/nas_10/datasets/ScanNet_clean/scans"
    if args.result_folder is None:
        result_folder = os.path.join(os.path.dirname(args.mesh_path), "evaluation")
    else:
    ...
    # intrinsic_path = os.path.join(os.path.join(root_dir, args.scene, "intrinsic/intrinsic_color.txt"))
    ...
    # else:
    #     gt_mesh = os.path.join(root_dir, args.scene, f"{args.scene}_vh_clean_2.ply")
    if "block2" in args.mesh_path:
        gt_mesh = "/mnt/nas_10/group/zhangxiyu/datasets/matrixcity_block2/gt_mesh_post.ply"
    elif "block3" in args.mesh_path:
        gt_mesh = "/mnt/nas_10/group/zhangxiyu/datasets/matrixcity_block3/gt_mesh_post.ply"
    elif "block4" in args.mesh_path:
        gt_mesh = "/mnt/nas_10/group/zhangxiyu/datasets/matrixcity_block4/gt_mesh_post.ply"
    elif "block5" in args.mesh_path:
        gt_mesh = "/mnt/nas_10/group/zhangxiyu/datasets/matrixcity_block5/gt_mesh_post.ply"
    elif "block6" in args.mesh_path:
        gt_mesh = "/mnt/nas_10/group/zhangxiyu/datasets/matrixcity_block6/gt_mesh_post.ply"
    elif "matrixcity-wdist" in args.mesh_path:
        gt_mesh = "/mnt/nas_10/group/zhangxiyu/datasets/matrixcity_block3/gt_mesh_post.ply"
    ...
    metrics = evaluate(mesh, gt_mesh, threshold=0.05, save_path=result_folder)
    print(metrics)