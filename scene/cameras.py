...
def confidence_func(value):
    return torch.sigmoid(10 * (value - 0.5))

class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, normal, image, gt_alpha_mask,
                 image_name, uid, depth = None, mask = None, K = None, semantic = None,
        ...
        self.semantic = semantic.to(self.data_device) if semantic is not None else None
        ...
        if K is not None:
            ...
            fy = fov2focal(FoVx, self.image_height)
